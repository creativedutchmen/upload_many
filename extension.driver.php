		...
		public function initaliseAdminPageHead($context) {
			...
			if($result['num'] > 0){
				...
				elseif($page instanceof ContentPublish and ($page->_context['page'] == 'new' || $page->_context['page'] == 'edit')) {
					...
					$page->addScriptToHead(URL . '/extensions/upload_many/assets/stage/symphony.stage.js', 992);
					$page->addStylesheetToHead(URL . '/extensions/upload_many/assets/stage/symphony.stage.css', 992);
